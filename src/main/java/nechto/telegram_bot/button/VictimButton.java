...
import static nechto.utils.CommonConstants.VICTIM_BUTTON;

@RequiredArgsConstructor
@Component
public class VictimButton implements Button {
    ...
    public BotApiMethod<?> onButtonPressed(CallbackQuery callbackquery, Long userId) {
        ...
        scoresService.addStatus(VICTIM, userIdToCount, gameId);
        return null;
