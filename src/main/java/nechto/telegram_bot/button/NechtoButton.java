...
import static nechto.utils.CommonConstants.NECHTO_BUTTON;
import static nechto.utils.CommonConstants.SCORES;

@RequiredArgsConstructor
@Component
public class NechtoButton implements Button {
    ...
    public BotApiMethod<?> onButtonPressed(CallbackQuery callbackquery, Long userId) {
        ...
        scoresService.addStatus(NECHTO, userIdToCount, gameId);
        return inlineKeyboardService.returnButtonsWithFlamethrower(userId);
