...
public class CommonConstants {
    ...
    public static final String WIN_BUTTON = "WIN_BUTTON";
    public static final String LOOSE_BUTTON = "LOOSE_BUTTON";
    public static final String BURNED_BUTTON = "BURNED_BUTTON";
    public static final String NECHTO_BUTTON = "NECHTO_BUTTON";
    ...
    public static final String END_COUNT_BUTTON = "END_COUNT_BUTTON";
    public static final String END_GAME_BUTTON = "END_GAME_BUTTON";
    public static final String COUNT_NEXT_BUTTON = "COUNT_NEXT_BUTTON";
